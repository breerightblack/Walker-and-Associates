...
<div class="pa-page-hero">
  <!-- Hero photo slot: drop taxes.jpg into assets/images/practice-areas/ -->
  <div class="pa-page-hero-img" style="background-image:url('<?php echo esc_url( wa_img( 'practice-areas/taxes.jpg' ) ); ?>')" role="presentation"></div>
