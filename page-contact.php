        ...
        <aside style="position:sticky;top:calc(var(--header-h) + var(--topbar-h) + var(--space-lg));">
          <div style="background:var(--bg-light);border-radius:var(--radius-lg);padding:var(--space-xl);margin-bottom:var(--space-lg);">
            ...
            <ul class="pay-methods">
                ...
                <li><span class="pay-icon"><img src="<?php echo esc_url( wa_img( 'payment/paypal.png' ) ); ?>" alt="PayPal" width="20" height="20" loading="lazy"></span>PayPal</li>
                <li><span class="pay-icon"><img src="<?php echo esc_url( wa_img( 'payment/zelle.png' ) ); ?>" alt="Zelle" width="20" height="20" loading="lazy"></span>Zelle</li>
                ...
                <li><span class="pay-icon"><img src="<?php echo esc_url( wa_img( 'payment/mycase.png' ) ); ?>" alt="MyCase" width="20" height="20" loading="lazy"></span>MyCase</li>
          ...
          <div class="legal-notice" style="margin-bottom:var(--space-lg);">
            ...
            <p>Payment of the consultation fee secures your appointment time and entitles you to a 30 minute legal consultation. Booking and paying for a consultation creates a limited attorney-client relationship for the duration of that consultation so that we can provide legal advice about your situation. It does not, by itself, create an ongoing attorney-client relationship for continued representation in your matter.</p>
          ...
          <div style="background:var(--bg-light);border-radius:var(--radius-lg);padding:var(--space-xl);margin-bottom:var(--space-lg);">
            ...
            <div style="display:flex;flex-direction:column;gap:var(--space-md);">
              <div style="display:flex;gap:12px;align-items:flex-start;">
                ...
                <div><p style="font-size:.9375rem;font-weight:600;color:var(--text-dark);margin-bottom:2px;">Address</p><p style="font-size:.875rem;color:var(--taupe);">The Walker Building<br>3427 Main Street<br>Atlanta, GA 30337</p></div>
              </div>
              <div style="display:flex;gap:12px;align-items:flex-start;">
