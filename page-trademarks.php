<?php
/**
 * Template Name: PA — Trademarks
 *
 * GENERATED from practice-areas/trademarks.html by _build/html-to-php.py — do not hand-edit.
 */
get_header();
?>

<div class="pa-page-hero">
  <!-- Hero photo slot: drop trademarks.jpg into assets/images/practice-areas/ -->
  <div class="pa-page-hero-img" style="background-image:url('<?php echo esc_url( wa_img( 'practice-areas/trademarks.jpg' ) ); ?>')" role="presentation"></div>
  ...
  <div class="container pa-page-hero-content">
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span class="breadcrumb-current" aria-current="page">Trademarks</span>
    </nav>
      ...
      <div class="pa-page-layout">
        ...
        <aside class="pa-page-aside">
          <div class="consult-card">
            ...
            <p style="font-size:.9375rem;color:var(--text-mid);line-height:1.7;margin-bottom:var(--space-md);">Speak with an attorney about trademarks. A flat $250 fee applies to initial consultations.</p>
