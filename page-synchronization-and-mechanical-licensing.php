<?php
/**
 * Template Name: PA — Synchronization &amp; Mechanical Licensing
 *
 * GENERATED from practice-areas/synchronization-and-mechanical-licensing.html by _build/html-to-php.py — do not hand-edit.
 */
get_header();
?>

<div class="pa-page-hero">
  <!-- Hero photo slot: drop synchronization-and-mechanical-licensing.jpg into assets/images/practice-areas/ -->
  <div class="pa-page-hero-img" style="background-image:url('<?php echo esc_url( wa_img( 'practice-areas/synchronization-and-mechanical-licensing.jpg' ) ); ?>')" role="presentation"></div>
  ...
  <div class="container pa-page-hero-content">
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span class="breadcrumb-current" aria-current="page">Synchronization &amp; Mechanical Licensing</span>
    </nav>
    <span class="eyebrow">Multi-market Legal Firm</span>
    <h1>Synchronization &amp; Mechanical Licensing</h1>
  </div>
</div>
...
<main id="main" role="main">
  <section class="section">
    <div class="container">
      <div class="pa-page-layout">
        <article class="pa-page-body">
        ...
        <aside class="pa-page-aside">
          <div class="consult-card">
            ...
            <p style="font-size:.9375rem;color:var(--text-mid);line-height:1.7;margin-bottom:var(--space-md);">Speak with an attorney about synchronization &amp; Mechanical Licensing. A flat $250 fee applies to initial consultations.</p>
          ...
          <div class="pa-page-related">
            <p class="pa-page-related-label">All Practice Areas</p>
            <ul>
